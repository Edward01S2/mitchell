<article <?php (post_class('py-6 xl:py-8')); ?> x-data="{img: <?php echo (!$feat) ? 'false' : 'true';; ?>}">
  <div class="flex flex-col p-6 border-container md:flex-row md:space-x-12 xl:p-8" :class="{ 'bg-c-blue-300 md:py-12 xl:py-16' : !img }">
    <div class="md:w-1/3 lg:w-1/4">
      <?php if(isset($feat) && $feat): ?>
        <a href="<?php echo e($link); ?>" <?php echo e($external ? 'target="_blank"' : ''); ?>>
          <img class="object-cover object-center w-full h-48 mb-6 md:mb-0" src="<?php echo $feat; ?>" alt="">
        </a>
      <?php endif; ?>
    </div>
    <div class="md:w-2/3 lg:w-3/4" :class="{ 'text-white' : !img }">
      ...
      <a href="<?php echo $link; ?>" class="inline-flex items-center font-whyte hover:underline" :class="{ 'text-white' : !img, 'text-c-blue-150' : img }" <?php echo e($external ? 'target="_blank"' : ''); ?>>
