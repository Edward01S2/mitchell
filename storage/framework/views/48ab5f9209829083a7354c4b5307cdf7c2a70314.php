<div class="">
  <div class="relative z-10">
    <div class="relative z-10 h-40 bg-center bg-cover bg-c-gray-200 md:h-72 lg:h-96 xl:h-108" style="background-image: url('<?php echo $bg; ?>')"></div>
      ...
      <div class="px-6 py-4 text-sm bg-white border-b border-gray-100 md:flex md:justify-end md:items-center md:space-x-6 md:px-8 xl:py-6 lg:space-x-8 xl:px-12">
        <?php if(get_the_author() !== 'admin'): ?>      
          <p class="text-gray-600 byline author vcard font-whyte">
            <span><?php echo e(__('Author:', 'sage')); ?></span>
            <span class="uppercase"><?php echo e(get_the_author()); ?></span>
          </p>
        <?php endif; ?>
        <time class="text-gray-600 uppercase updated font-whyte" datetime="<?php echo e(get_post_time('c', true)); ?>">
...
<?php /**PATH /Users/edward/Desktop/wordpress/mitchell/wp-content/themes/mitchell/resources/views/partials/content-single.blade.php ENDPATH**/ ?>