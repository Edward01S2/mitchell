<div class="{{ $block->classes ?? '' }}">
  <div class="relative bg-center bg-cover bg-c-gray-200 md:min-h-20 lg:min-h-24 xl:min-h-30" style="background-image: url('{!! ($bg) ? $bg : ''; !!}')">
    ...
    <div class="container relative z-20 px-6 pt-32 pb-16 mx-auto md:pt-32 lg:px-8 lg:pt-36 lg:pb-20">
      <div class="text-white md:w-3/5 lg:w-1/2">
        @if(isset($pretitle) && $pretitle)
          <div class="mb-2 text-xl tracking-widest uppercase font-whyte md:text-2xl xl:max-w-lg 2xl:max-w-xl">{!! $pretitle !!}</div>
        @endif
        ...
        @if(isset($video) && $video)
          <a class="flex items-center mt-6 text-sm font-medium text-black uppercase font-whyte hover:text-white" href="{!! $video_url !!}" data-lity>
