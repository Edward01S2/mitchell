                        ...
                        @foreach($tag_filters['top'] as $key => $value)
                          <div class="border filter md:flex md:items-center md:w-full md:h-full border-c-blue-200 bg-c-blue-400">
                            <label class="md:w-full md:h-full md:flex md:items-center">
                              ...
                              <div class="px-6 py-3 text-lg text-center cursor-pointer md:w-full md:py-4 md:leading-tight md:flex md:items-center md:h-full md:justify-center">{!! $value !!}</div>
                            </label>
                          </div>
                        @endforeach
                      </div>
